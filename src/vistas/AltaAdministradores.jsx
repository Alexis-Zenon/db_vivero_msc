...
export default function AltaAdministradores({ usuarioActivo, onRegistroExitoso }) {
  ...
  const verificarYAutorizarRol = async () => {
    ...
    try {
      const resValida = await fetch("https://db-vivero-msc.onrender.com/usuarios/verificar-password", {
        method: "POST",
  ...
  const enviarFormulario = async (e) => {
    ...
    try {
      const respuesta = await fetch("https://db-vivero-msc.onrender.com/usuarios/registrar-personal", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
