...
export default function GestionTemporadas() {
  ...
  const obtenerTemporadas = async () => {
    try {
      const res = await fetch('http://db-vivero-msc.onrender.com/temporadas');
      if (res.ok) {
  ...
  const guardarTemporada = async (e) => {
    ...
    try {
      const url = idEditando 
        ? `http://db-vivero-msc.onrender.com/temporadas/${idEditando}` 
        : 'http://db-vivero-msc.onrender.com/temporadas';
  ...
  const eliminarTemporada = async (id) => {
    ...
    try {
      const res = await fetch(`http://db-vivero-msc.onrender.com/temporadas/${id}`, {
        method: 'DELETE'
      });
      if (res.ok) {
